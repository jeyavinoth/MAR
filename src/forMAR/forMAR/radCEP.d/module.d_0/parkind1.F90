...
INTEGER, PARAMETER :: JPRM = SELECTED_REAL_KIND(6,37) ! simple precision
INTEGER, PARAMETER :: JPRB = SELECTED_REAL_KIND(6,37) ! simple precision
!INTEGER, PARAMETER :: JPRB = SELECTED_REAL_KIND(13,300) !double
! XF #XF
END MODULE PARKIND1
